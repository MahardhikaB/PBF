...
export default function DataUser() {
    ...
    return (
        ...
        <Modal show={openModal} size="md" className="bg-black bg-opacity-75" onClose={() => setOpenModal(false)} popup>
            ...
            <div className='absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 h-100 w-1/2 rounded-2xl bg-white flex flex-col text-black'>
                <h1 className='p-3 m-3 font-bold text-2xl'>Tambah User</h1>
                <div className='h-1 w-full bg-white'/>
                <h1 className="pl-16 font-bold">User ID</h1>
                <div className="flex flex-row mr-16">
                <input type="text" className='ml-16 mr-3 mt-1 mb-2 w-full rounded-2xl bg-white py-3 font-bold focus:border-black' />
                ...
                <input type="text" className='mx-16 mt-1 mb-2 rounded-2xl bg-white p-3 font-bold' />
                <h1 className="pl-16 pt-1 font-bold">Email</h1>
                <input type="email" className='mx-16 mt-1 mb-2 rounded-2xl bg-white p-3 font-bold' />
                <h1 className="pl-16 pt-1 font-bold">Password Key</h1>
                <div className="flex flex-row mr-16">
                <input type="text" className='ml-16 mr-3 mt-1 mb-2 w-full rounded-2xl bg-white p-3 font-bold' />
                <Button className="mt-1 mb-2 rounded-xl bg-black text-white font-semibold p-1 items-center">
                Generate
                </Button>
                </div>
                
                <Link className='mx-16 my-4 rounded-2xl bg-[#0090FA] p-3 text-white border-none active:border-none text-center font-bold' href={'/data_user'} >Simpan</Link>
                <button onClick={() => setOpenModal(false)} className="text-black">Close</button>
            </div>
            </Modal.Body>
        </Modal>
        </DashTemplate>
