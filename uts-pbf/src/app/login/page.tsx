    ...
    return (
        <div className='relative w-screen h-screen'>
            ...
            <div className='absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 h-80 w-1/4 rounded-2xl bg-[#E3F3FF] flex flex-col'>
                ...
                <input type="text" placeholder='Email' className='m-5 rounded-2xl bg-white p-3 placeholder-[#0090FA] font-bold text-[#0090FA]' />
                <input type="password" placeholder='Password' className='ml-5 mr-5 mt-1 mb-3 rounded-2xl bg-white p-3 placeholder-[#0090FA] font-bold text-[#0090FA]' />
